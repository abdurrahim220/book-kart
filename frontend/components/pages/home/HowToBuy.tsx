...
import { buySteps } from '@/components/constant/homeContent'
import React from 'react'

const HowToBuy = () => {
    return (
        <section className="py-16 lg:py-20 bg-gradient-to-b from:bg-gray-50 to-white">
        <WrapperContainer>
            <div className='text-center font-bold py-4'>
                <h2 className='text-3xl font-bold my-4'>
                    How to buy old books online on Bookstore
                </h2>
                ...
                <div className="hidden md:block absolute top-1/2 left-1/4 right-1/4  h-0.5 border-dashed border-gray-300 -z-10"></div>
                {
                    buySteps.map((step, index) => (
                        <div key={index} className="relative flex flex-col items-center h-full">
                            <div className="bg-yellow-400 rounded-xl p-8 shadow-xl flex-grow items-center flex flex-col">
